...
const Update = () => {
    ...
    function handleSubmit(event){
        ...
        // axios.put('http://localhost:8081/update/' + id,{name,email,phone,date})
        axios.put('http://localhost:8081/update/' + id, {name, email, phone, date})
    ...
    <div className='mt-20 flex justify-center items-center'>
      <div className=' text-black flex justify-center items-center md:w-[600px] w-[380px] bg-white rounded'>
            <form onSubmit={handleSubmit}>
                <h1 className=' text-center font-semibold text-gray-600 mb-8 mt-4'>Update Student</h1>
                ...
                <button className='  to-gray-700 font-semibold bg-slate-600 p-2 mb-8 mt-4 rounded  w-72'>Update</button>
            </form>
      </div>
    </div>
  )
